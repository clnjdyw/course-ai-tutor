...
- Name: 01-login.spec.cjs >> 登录注册模块 >> TC07 - 角色选择：学生/教师切换
- Location: tests\e2e\01-login.spec.cjs:66:3
...
Locator: locator('.el-radio-button.is-active')
Expected substring: "学生"
Error: strict mode violation: locator('.el-radio-button.is-active') resolved to 2 elements:
    1) <label data-v-67e64f9f="" class="el-radio-button is-active el-radio-button--large role-btn">…</label> aka getByLabel('登录').locator('label').filter({ hasText: '🎓 学生' })
    2) <label data-v-67e64f9f="" class="el-radio-button is-active el-radio-button--large role-btn">…</label> aka getByLabel('注册').locator('label').filter({ hasText: '🎓 学生' })

Call log:
  - Expect "toContainText" with timeout 5000ms
  - waiting for locator('.el-radio-button.is-active')
...
- generic [ref=e10]:
  ...
  - generic [ref=e20]:
    ...
    - tabpanel "登录" [ref=e29]:
      ...
      - generic [ref=e40]:
        - generic [ref=e44]:
          - img [ref=e47]
          - textbox "请输入用户名" [ref=e49]
        - generic [ref=e53]:
          - img [ref=e56]
          - textbox "请输入密码" [ref=e59]
        - generic [ref=e62]:
          - generic [ref=e63] [cursor=pointer]:
            - generic [ref=e64]:
              - checkbox "记住我"
            - generic [ref=e66]: 记住我
          - generic [ref=e68] [cursor=pointer]: 忘记密码？
        - button "登录" [ref=e71] [cursor=pointer]:
          - generic [ref=e72]:
            - img [ref=e74]
            - text: 登录
  ...
  - paragraph [ref=e85]:
    - text: 登录即代表您同意
    - generic [ref=e87] [cursor=pointer]: 用户协议
    - text: 和
    - generic [ref=e89] [cursor=pointer]: 隐私政策
```
