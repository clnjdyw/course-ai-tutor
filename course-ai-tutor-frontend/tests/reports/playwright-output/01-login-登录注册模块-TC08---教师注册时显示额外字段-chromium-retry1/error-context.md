...
- Name: 01-login.spec.cjs >> 登录注册模块 >> TC08 - 教师注册时显示额外字段
- Location: tests\e2e\01-login.spec.cjs:72:3
...
Call log:
  - waiting for getByRole('radio', { name: /教师/ })
    - locator resolved to <input type="radio" value="teacher" name="el-id-2528-5" class="el-radio-button__original-radio"/>
  - attempting click action
    2 × waiting for element to be visible, enabled and stable
      - element is visible, enabled and stable
      - scrolling into view if needed
      - done scrolling
      - <span class="el-radio-button__inner">…</span> intercepts pointer events
