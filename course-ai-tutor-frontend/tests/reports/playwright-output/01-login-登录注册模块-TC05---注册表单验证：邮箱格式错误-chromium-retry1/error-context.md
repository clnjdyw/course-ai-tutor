...
- Name: 01-login.spec.cjs >> 登录注册模块 >> TC05 - 注册表单验证：邮箱格式错误
- Location: tests\e2e\01-login.spec.cjs:40:3
...
Call log:
  - waiting for locator('input[placeholder="请输入用户名"]')
    - locator resolved to <input type="text" tabindex="0" autocomplete="off" id="el-id-6266-12" placeholder="请输入用户名" class="el-input__inner"/>
    - fill("testuser")
