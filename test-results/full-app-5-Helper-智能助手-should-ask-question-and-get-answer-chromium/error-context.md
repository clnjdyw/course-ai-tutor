...
- Name: full-app.spec.js >> 5. Helper (智能助手) >> should ask question and get answer
- Location: tests\e2e\full-app.spec.js:232:3
        ...
        - generic [ref=e171]:
          - generic [ref=e172]:
            - generic [ref=e173]:
              - img [ref=e176]
              - generic [ref=e179]:
                - heading "💬 实时答疑" [level=2] [ref=e180]
                - paragraph [ref=e181]: 7×24 小时在线，随时解答你的疑问
            - generic [ref=e184]:
              - img [ref=e186] [cursor=pointer]
              - text: 7×24 在线
          - separator [ref=e190]
          - generic [ref=e191]:
            - generic [ref=e194]: 快捷提问
            - generic [ref=e195]:
              - generic [ref=e197] [cursor=pointer]: 什么是依赖注入？
              - generic [ref=e199] [cursor=pointer]: Spring Boot 自动配置原理
              - generic [ref=e201] [cursor=pointer]: 如何理解 MVC 模式？
              - generic [ref=e203] [cursor=pointer]: RESTful API 设计规范
              - generic [ref=e205] [cursor=pointer]: 数据库索引的优缺点
              - generic [ref=e207] [cursor=pointer]: 解释一下闭包的概念和应用
              - generic [ref=e209] [cursor=pointer]: Vue 3 的 Composition API 有什么优势？
              - generic [ref=e211] [cursor=pointer]: 如何优化前端性能？
              - generic [ref=e213] [cursor=pointer]: 什么是微服务架构？
              - generic [ref=e215] [cursor=pointer]: Git 的 rebase 和 merge 有什么区别？
          - separator [ref=e216]
          - generic [ref=e217]:
            - generic [ref=e218]:
              - textbox "请输入你的问题，例如：IOC 和 DI 有什么区别？或上传图片让 AI 识别" [active] [ref=e220]: 什么是闭包？
              - generic [ref=e221]:
                - button "上传图片" [ref=e223] [cursor=pointer]:
                  - button "上传图片" [ref=e224]:
                    - generic [ref=e225]:
                      - img [ref=e227]
                      - text: 上传图片
                - button "语音输入" [ref=e230] [cursor=pointer]:
                  - generic [ref=e231]:
                    - img [ref=e233]
                    - text: 语音输入
                - button "提交问题" [ref=e235] [cursor=pointer]:
                  - generic [ref=e236]:
                    - img [ref=e238]
                    - text: 提交问题
                - button "清空" [ref=e240] [cursor=pointer]:
                  - generic [ref=e241]:
                    - img [ref=e243]
                    - text: 清空
            - button "🔧 代码调试" [ref=e247] [cursor=pointer]:
              - generic [ref=e251]: 🔧 代码调试
              - img [ref=e253]
            - generic [ref=e255]:
              - img [ref=e259]
              - paragraph [ref=e263]: 输入问题，AI 将为你详细解答
```