...
- Name: full-app.spec.js >> 3. Smart Tutor (智能教学) >> should load tutor page
- Location: tests\e2e\full-app.spec.js:162:3
          ...
          - generic [ref=e171]:
            - generic [ref=e173]:
              ...
              - generic [ref=e180]:
                ...
                - button "🗑️ 清空对话" [disabled] [ref=e183]:
            ...
            - generic [ref=e186]:
              ...
              - generic [ref=e199]:
                - generic [ref=e200]:
                  - generic [ref=e201]: ⚡
                  - generic [ref=e202]: 快捷提问
                - generic [ref=e203]:
                  - generic [ref=e205] [cursor=pointer]: 什么是依赖注入？
                  - generic [ref=e207] [cursor=pointer]: Spring Boot 自动配置原理
                  - generic [ref=e209] [cursor=pointer]: 如何理解 MVC 模式？
                  - generic [ref=e211] [cursor=pointer]: RESTful API 设计规范
                  - generic [ref=e213] [cursor=pointer]: 数据库索引的优缺点
                  - generic [ref=e215] [cursor=pointer]: 解释一下闭包的概念和应用
                  - generic [ref=e217] [cursor=pointer]: Vue 3 的 Composition API 有什么优势？
                  - generic [ref=e219] [cursor=pointer]: 如何优化前端性能？
                  - generic [ref=e221] [cursor=pointer]: 什么是微服务架构？
                  - generic [ref=e223] [cursor=pointer]: Git 的 rebase 和 merge 有什么区别？
              - generic [ref=e225]:
                - textbox "请输入你想学习的知识点，例如：什么是依赖注入？" [ref=e227]
                - generic [ref=e228]:
                  - generic [ref=e229]:
                    - generic [ref=e230]: 📊 难度：
                    - generic [ref=e232] [cursor=pointer]:
                      - generic:
                        - combobox [ref=e234]
                        - generic [ref=e235]: 🌱 零基础
                      - img [ref=e238]
                  - generic [ref=e240]:
                    - button "🖼️ 图片" [ref=e241] [cursor=pointer]:
                      - generic [ref=e242]: 🖼️ 图片
                    - button "🎤 语音" [ref=e243] [cursor=pointer]:
                      - generic [ref=e244]: 🎤 语音
                    - button "发送" [disabled] [ref=e245]:
                      - generic [ref=e246]: 发送
  - alert [ref=e247]:
    - img [ref=e249]
    - paragraph [ref=e251]: Request failed with status code 429
```