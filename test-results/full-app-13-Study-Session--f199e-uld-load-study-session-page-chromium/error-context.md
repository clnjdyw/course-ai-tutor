...
- Name: full-app.spec.js >> 13. Study Session (学习会话) >> should load study session page
- Location: tests\e2e\full-app.spec.js:434:3
        ...
        - main [ref=e169]:
          - generic [ref=e171]:
            - generic [ref=e174]:
              - generic [ref=e176]: 📖
              - generic [ref=e177]:
                - heading "📖 学习协调器" [level=2] [ref=e178]
                - paragraph [ref=e179]: AI 驱动的智能学习会话，支持学习、练习、复习三种模式
            - generic [ref=e181]:
              - generic [ref=e182]:
                - generic [ref=e183]: 🚀
                - heading "开始新的学习旅程" [level=3] [ref=e184]
                - paragraph [ref=e185]: 选择你想要学习的主题和模式，AI 将为你定制专属学习方案
              - generic [ref=e186]:
                - generic [ref=e187]:
                  - generic [ref=e188]: 📚 学习主题
                  - textbox "📚 学习主题" [ref=e191]:
                    - /placeholder: 请输入你想学习的知识点，例如：Vue 3 Composition API、数据结构与算法、Spring Boot 核心概念
                - generic [ref=e192]:
                  - generic [ref=e193]: 🎯 学习模式
                  - radiogroup "🎯 学习模式" [ref=e195]:
                    - generic [ref=e196]:
                      - radio "📚 学习模式 系统讲解知识点" [checked] [ref=e197]
                      - generic [ref=e199] [cursor=pointer]:
                        - generic [ref=e200]: 📚
                        - generic [ref=e201]: 学习模式
                        - generic [ref=e202]: 系统讲解知识点
                    - generic [ref=e203]:
                      - radio "✏️ 练习模式 做题巩固知识" [ref=e204]
                      - generic [ref=e206] [cursor=pointer]:
                        - generic [ref=e207]: ✏️
                        - generic [ref=e208]: 练习模式
                        - generic [ref=e209]: 做题巩固知识
                    - generic [ref=e210]:
                      - radio "🔄 复习模式 回顾已学内容" [ref=e211]
                      - generic [ref=e213] [cursor=pointer]:
                        - generic [ref=e214]: 🔄
                        - generic [ref=e215]: 复习模式
                        - generic [ref=e216]: 回顾已学内容
                - button "开始学习" [disabled] [ref=e219]:
                  - generic [ref=e221]: 开始学习
  - alert [ref=e222]:
    - img [ref=e224]
    - paragraph [ref=e226]: Request failed with status code 429
```