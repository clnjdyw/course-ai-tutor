...
- Name: full-app.spec.js >> 7. Custom Exercise Templates (自定义题库) >> should create new template
- Location: tests\e2e\full-app.spec.js:293:3
            ...
            - generic [ref=e171]:
              - generic [ref=e172]:
                - generic [ref=e173]:
                  - img [ref=e176]
                  - generic [ref=e179]:
                    - heading "📝 自定义题库" [level=2] [ref=e180]
                    - paragraph [ref=e181]: 创建题目模板，一键生成练习
                - button "新建模板" [ref=e182] [cursor=pointer]:
                  - generic [ref=e183]:
                    - img [ref=e185]
                    - text: 新建模板
              - separator [ref=e187]
              - generic [ref=e189]:
                - img [ref=e191]
                - paragraph [ref=e208]: 还没有模板，点击上方按钮创建
            - dialog "新建模板" [ref=e210]:
              - generic [ref=e211]:
                - generic [ref=e212]:
                  - heading "新建模板" [level=2] [ref=e213]
                  - button "关闭此对话框" [ref=e214] [cursor=pointer]:
                    - img [ref=e216]
                - generic [ref=e219]:
                  - generic [ref=e220]:
                    - generic [ref=e221]: 模板名称
                    - textbox "模板名称" [active] [ref=e225]:
                      - /placeholder: 例如：高等数学期中复习
                      - text: 数学测试
                  - generic [ref=e226]:
                    - generic [ref=e227]: 题目数量
                    - generic [ref=e229]:
                      - button "减少数值" [ref=e230] [cursor=pointer]:
                        - img [ref=e232]
                      - button "增加数值" [ref=e234] [cursor=pointer]:
                        - img [ref=e236]
                      - spinbutton "题目数量" [ref=e240]: "10"
                  - group "难度分布" [ref=e241]:
                    - generic [ref=e242]: 难度分布
                    - generic [ref=e244]:
                      - generic [ref=e245]:
                        - generic [ref=e246]: 简单
                        - slider "滑块介于 0 至 100" [ref=e250] [cursor=pointer]
                      - generic [ref=e252]:
                        - generic [ref=e253]: 中等
                        - slider "滑块介于 0 至 100" [ref=e257] [cursor=pointer]
                      - generic [ref=e259]:
                        - generic [ref=e260]: 困难
                        - slider "滑块介于 0 至 100" [ref=e264] [cursor=pointer]
                  - group "题型比例" [ref=e266]:
                    - generic [ref=e267]: 题型比例
                    - generic [ref=e269]:
                      - generic [ref=e270]:
                        - generic [ref=e271]: 选择题
                        - slider "滑块介于 0 至 100" [ref=e275] [cursor=pointer]
                      - generic [ref=e277]:
                        - generic [ref=e278]: 填空题
                        - slider "滑块介于 0 至 100" [ref=e282] [cursor=pointer]
                      - generic [ref=e284]:
                        - generic [ref=e285]: 解答题
                        - slider "滑块介于 0 至 100" [ref=e289] [cursor=pointer]
                - generic [ref=e291]:
                  - button "取消" [ref=e292] [cursor=pointer]:
                    - generic [ref=e293]: 取消
                  - button "创建模板" [ref=e294] [cursor=pointer]:
                    - generic [ref=e295]: 创建模板
  - alert [ref=e296]:
    - img [ref=e298]
    - paragraph [ref=e300]: Request failed with status code 429
```