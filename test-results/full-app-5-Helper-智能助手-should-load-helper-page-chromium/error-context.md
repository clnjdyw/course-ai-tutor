...
- Name: full-app.spec.js >> 5. Helper (智能助手) >> should load helper page
- Location: tests\e2e\full-app.spec.js:226:3
    ...
    - generic [ref=e148]:
      ...
      - main [ref=e169]:
        - generic [ref=e171]:
          ...
          - generic [ref=e217]:
            - generic [ref=e218]:
              - textbox "请输入你的问题，例如：IOC 和 DI 有什么区别？或上传图片让 AI 识别" [ref=e220]
              - generic [ref=e221]:
