...
- Name: full-app.spec.js >> 1. Authentication >> should login with admin credentials
- Location: tests\e2e\full-app.spec.js:86:3
          ...
          - generic [ref=e171]:
            - generic [ref=e173]:
              - generic [ref=e174]:
                - img [ref=e177]
                - generic [ref=e179]:
                  - heading "管理员控制面板" [level=2] [ref=e180]
                  - paragraph [ref=e181]: 系统管理与数据监控
              - button "刷新数据" [disabled]:
                - generic:
                  - img
                - generic:
                  - generic:
            ...
            - generic [ref=e183]:
              - tablist [ref=e187]:
                ...
                - tab "安全设置" [ref=e196]
                - tab "维护模式" [ref=e197]
              - tabpanel "数据概览" [ref=e199]:
                - generic [ref=e200]:
                  - generic [ref=e201]:
                    - img [ref=e204]
                    - generic [ref=e206]:
                      - generic [ref=e207]: "0"
                      - generic [ref=e208]: 总用户数
                  - generic [ref=e209]:
                    - img [ref=e212]
                    - generic [ref=e214]:
                      - generic [ref=e215]: "0"
                      - generic [ref=e216]: 活跃用户
                  - generic [ref=e217]:
                    - img [ref=e220]
                    - generic [ref=e222]:
                      - generic [ref=e223]: "0"
                      - generic [ref=e224]: 总练习数
                  - generic [ref=e225]:
                    - img [ref=e228]
                    - generic [ref=e230]:
                      - generic [ref=e231]: 0%
                      - generic [ref=e232]: 平均分数
                - generic [ref=e233]:
                  - generic [ref=e235]:
                    - generic [ref=e236]: AI 系统分析
                    - button "运行分析" [ref=e237] [cursor=pointer]:
                      - generic [ref=e238]:
                        - img [ref=e240]
                        - text: 运行分析
                  - generic [ref=e243]:
                    - img [ref=e245]
                    - paragraph [ref=e262]: 点击上方按钮运行 AI 系统分析
  - alert [ref=e263]:
    - img [ref=e265]
    - generic [ref=e267]:
      - heading "✅ 登录成功" [level=2] [ref=e268]
      - paragraph [ref=e270]: 欢迎回来，管理员 admin！
      - img [ref=e272] [cursor=pointer]
  - alert [ref=e274]:
    - img [ref=e276]
    - paragraph [ref=e278]: 网络连接失败，请检查网络设置
```