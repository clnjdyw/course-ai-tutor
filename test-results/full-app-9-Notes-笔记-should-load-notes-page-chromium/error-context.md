...
- Name: full-app.spec.js >> 9. Notes (笔记) >> should load notes page
- Location: tests\e2e\full-app.spec.js:348:3
...
- generic [active] [ref=e1]:
  ...
  - alert [ref=e196]:
    - img [ref=e198]
    - paragraph [ref=e200]: Request failed with status code 429
```