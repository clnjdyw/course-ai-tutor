...
- Name: full-app.spec.js >> 14. Reminders (学习提醒) >> should load reminders page
- Location: tests\e2e\full-app.spec.js:449:3
          ...
          - generic [ref=e171]:
            - generic [ref=e173]:
              - generic [ref=e174]:
                - generic [ref=e176]: ⏰
                - generic [ref=e177]:
                  - heading "⏰ 学习提醒" [level=2] [ref=e178]
                  - paragraph [ref=e179]: 不错过每一个重要时刻
              - button "✨ 新建提醒" [ref=e180] [cursor=pointer]:
                - generic [ref=e181]:
                  - generic [ref=e182]: ✨
                  - text: 新建提醒
            - generic [ref=e184]:
              - generic [ref=e187]: ⏰
              - paragraph [ref=e189]: 还没有提醒，点击上方按钮创建第一个学习提醒吧！
  - alert [ref=e190]:
    - img [ref=e192]
    - paragraph [ref=e194]: Request failed with status code 429
```