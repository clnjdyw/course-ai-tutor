...
- Name: full-app.spec.js >> 7. Custom Exercise Templates (自定义题库) >> should generate exercises from template
- Location: tests\e2e\full-app.spec.js:314:3
...
- generic [active] [ref=e1]:
  ...
  - alert [ref=e209]:
    - img [ref=e211]
    - paragraph [ref=e213]: Request failed with status code 429
```