...
- Name: full-app.spec.js >> 2. Home Page / Dashboard >> should show planner page after login
- Location: tests\e2e\full-app.spec.js:142:3
        ...
        - generic [ref=e171]:
          - generic [ref=e173]:
            - generic [ref=e174]:
              - generic [ref=e176]: 🗺️
              - generic [ref=e177]:
                - heading "🗺️ 学习冒险地图" [level=2] [ref=e178]
                - paragraph [ref=e179]: AI 为你定制专属冒险路线
            - generic [ref=e181]: ✨ AI 魔法
          - generic [ref=e182]:
            - generic [ref=e184]:
              - generic [ref=e185]:
                - generic [ref=e186]: 🎯 冒险目标
                - textbox "🎯 冒险目标" [ref=e189]:
                  - /placeholder: 请输入你的学习目标，例如：学习 Spring Boot 框架
              - generic [ref=e190]:
                - generic [ref=e192]:
                  - generic [ref=e193]: 🌟 当前等级
                  - generic [ref=e196] [cursor=pointer]:
                    - generic:
                      - combobox "🌟 当前等级" [ref=e198]
                      - generic [ref=e199]: 请选择
                    - img [ref=e202]
                - generic [ref=e205]:
                  - generic [ref=e206]: ⏰ 每日能量
                  - generic [ref=e209]:
                    - generic [ref=e211]: ⚡
                    - textbox "⏰ 每日能量" [ref=e212]:
                      - /placeholder: 例如：每天 2 小时
              - generic [ref=e213]:
                - generic [ref=e214]: 💡 特殊技能
                - generic [ref=e217]:
                  - generic [ref=e219]: 🔮
                  - textbox "💡 特殊技能" [ref=e220]:
                    - /placeholder: 例如：喜欢实践、喜欢看视频等
              - generic [ref=e223]:
                - button "✨ 生成冒险地图" [ref=e224] [cursor=pointer]:
                  - generic [ref=e225]:
                    - generic [ref=e226]: ✨
                    - text: 生成冒险地图
                - button "🗑️ 清空" [ref=e227] [cursor=pointer]:
                  - generic [ref=e228]:
                    - generic [ref=e229]: 🗑️
                    - text: 清空
            - generic [ref=e230]:
              - generic [ref=e233]: 🗺️
              - paragraph [ref=e235]: 输入冒险目标，AI 将为你绘制专属冒险地图
```