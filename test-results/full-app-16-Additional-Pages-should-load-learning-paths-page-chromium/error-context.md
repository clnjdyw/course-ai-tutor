...
- Name: full-app.spec.js >> 16. Additional Pages >> should load learning paths page
- Location: tests\e2e\full-app.spec.js:524:3
          ...
          - generic [ref=e171]:
            - generic [ref=e173]:
              - generic [ref=e174]:
                - img [ref=e177]
                - generic [ref=e180]:
                  - heading "学习路径" [level=2] [ref=e181]
                  - paragraph [ref=e182]: 规划你的学习旅程
              - generic [ref=e183]:
                - button "智能推荐" [ref=e184] [cursor=pointer]:
                  - generic [ref=e185]:
                    - img [ref=e187]
                    - text: 智能推荐
                - button "新建路径" [ref=e189] [cursor=pointer]:
                  - generic [ref=e190]:
                    - img [ref=e192]
                    - text: 新建路径
            - generic [ref=e195]:
              - img [ref=e197]
              - paragraph [ref=e214]: 暂无学习路径，点击「新建路径」或「智能推荐」创建
  - alert [ref=e215]:
    - img [ref=e217]
    - paragraph [ref=e219]: Request failed with status code 429
  - alert [ref=e220]:
    - img [ref=e222]
    - paragraph [ref=e224]: 加载学习路径失败
```