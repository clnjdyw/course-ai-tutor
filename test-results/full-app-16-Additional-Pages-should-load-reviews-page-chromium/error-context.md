...
- Name: full-app.spec.js >> 16. Additional Pages >> should load reviews page
- Location: tests\e2e\full-app.spec.js:538:3
            ...
            - generic [ref=e171]:
              - generic [ref=e173]:
                - generic [ref=e174]:
                  - img [ref=e177]
                  - generic [ref=e181]:
                    - heading "今日待复习" [level=2] [ref=e182]
                    - paragraph [ref=e183]: 根据遗忘曲线安排的今日复习任务
                - button "智能生成" [ref=e185] [cursor=pointer]:
                  - generic [ref=e186]:
                    - img [ref=e188]
                    - text: 智能生成
              - generic [ref=e192]:
                - img [ref=e194]
                - paragraph [ref=e211]: 今日暂无复习任务
                - button "智能生成复习计划" [ref=e213] [cursor=pointer]:
                  - generic [ref=e214]:
                    - img [ref=e216]
                    - text: 智能生成复习计划
            - generic [ref=e218]:
              - generic [ref=e220]:
                - generic [ref=e221]:
                  - img [ref=e224]
                  - generic [ref=e226]:
                    - heading "全部复习计划" [level=2] [ref=e227]
                    - paragraph [ref=e228]: 管理您的所有复习任务
                - generic [ref=e229]:
                  - generic [ref=e231] [cursor=pointer]:
                    - generic:
                      - combobox [ref=e233]
                      - generic [ref=e234]: 筛选状态
                    - img [ref=e237]
                  - button "刷新" [ref=e239] [cursor=pointer]:
                    - generic [ref=e240]:
                      - img [ref=e242]
                      - text: 刷新
              - generic [ref=e246]:
                - img [ref=e248]
                - paragraph [ref=e265]: 暂无复习计划
                - button "智能生成复习计划" [ref=e267] [cursor=pointer]:
                  - generic [ref=e268]:
                    - img [ref=e270]
                    - text: 智能生成复习计划
  - alert [ref=e272]:
    - img [ref=e274]
    - paragraph [ref=e276]: Request failed with status code 429
  - alert [ref=e277]:
    - img [ref=e279]
    - paragraph [ref=e281]: Request failed with status code 429
```