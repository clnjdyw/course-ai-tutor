...
- Name: full-app.spec.js >> 10. Wrong Questions (错题本) >> should load wrong questions page
- Location: tests\e2e\full-app.spec.js:389:3
          ...
          - generic [ref=e171]:
            - generic [ref=e173]:
              - generic [ref=e174]:
                - generic [ref=e176]: ❌
                - generic [ref=e177]:
                  - heading "❌ 错题本" [level=2] [ref=e178]
                  - paragraph [ref=e179]: 温故而知新，消灭每一道错题
              - generic [ref=e180]:
                - button "AI 批量分析" [ref=e181] [cursor=pointer]:
                  - generic [ref=e182]:
                    - img [ref=e184]
                    - text: AI 批量分析
                - radiogroup "radio-group" [ref=e186]:
                  - generic [ref=e187]:
                    - radio "全部" [checked] [ref=e188]
                    - generic [ref=e189] [cursor=pointer]: 全部
                  - generic [ref=e190]:
                    - radio "未掌握" [ref=e191]
                    - generic [ref=e192] [cursor=pointer]: 未掌握
            - generic [ref=e194]:
              - generic [ref=e197]: 🎉
              - paragraph [ref=e199]: 太棒了！还没有错题，继续保持！
  - alert [ref=e200]:
    - img [ref=e202]
    - paragraph [ref=e204]: Request failed with status code 429
  - alert [ref=e205]:
    - img [ref=e207]
    - paragraph [ref=e209]: Request failed with status code 429
```