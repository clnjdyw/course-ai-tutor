...
- Name: full-app.spec.js >> 16. Additional Pages >> should load knowledge manage page
- Location: tests\e2e\full-app.spec.js:517:3
          ...
          - generic [ref=e171]:
            - generic [ref=e173]:
              - generic [ref=e174]:
                - generic [ref=e176]: 📚
                - generic [ref=e177]:
                  - heading "📚 知识点管理" [level=2] [ref=e178]
                  - paragraph [ref=e179]: 管理和维护课程知识点体系
              - button "✨ 新建知识点" [ref=e180] [cursor=pointer]:
                - generic [ref=e181]:
                  - generic [ref=e182]: ✨
                  - text: 新建知识点
            - generic [ref=e183]:
              - generic [ref=e184]:
                ...
                - generic [ref=e204]:
                  - generic [ref=e206]: 🔍
                  - textbox "搜索知识点..." [ref=e207]
                - button "搜索" [ref=e208] [cursor=pointer]:
                  - generic [ref=e209]: 搜索
              - generic [ref=e211]:
                - table [ref=e213]:
                  - rowgroup [ref=e221]:
                    - row "标题 所属课程 难度 描述 标签 操作" [ref=e222]:
                      - columnheader "标题" [ref=e223]:
                        - generic [ref=e224]: 标题
                      - columnheader "所属课程" [ref=e225]:
                        - generic [ref=e226]: 所属课程
                      - columnheader "难度" [ref=e227]:
                        - generic [ref=e228]: 难度
                      - columnheader "描述" [ref=e229]:
                        - generic [ref=e230]: 描述
                      - columnheader "标签" [ref=e231]:
                        - generic [ref=e232]: 标签
              ...
              - generic [ref=e242]:
                - generic [ref=e243]: 共 0 条
                - generic [ref=e246] [cursor=pointer]:
                  - generic:
                    - combobox [ref=e248]
                    - generic [ref=e249]: 20条/页
                  - img [ref=e252]
                - button "上一页" [disabled] [ref=e254]:
                  - generic:
                    - img
                - list [ref=e255]:
                  - listitem "第 1 页" [ref=e256]: "1"
                - button "下一页" [disabled] [ref=e257]:
                  - generic:
                    - img
  - alert [ref=e258]:
    - img [ref=e260]
    - paragraph [ref=e262]: Request failed with status code 429
  - alert [ref=e263]:
    - img [ref=e265]
    - paragraph [ref=e267]: Request failed with status code 429
  - alert [ref=e268]:
    - img [ref=e270]
    - paragraph [ref=e272]: 加载失败
```