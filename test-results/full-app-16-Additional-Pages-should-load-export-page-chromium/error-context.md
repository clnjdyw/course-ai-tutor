...
- Name: full-app.spec.js >> 16. Additional Pages >> should load export page
- Location: tests\e2e\full-app.spec.js:566:3
      ...
      - main [ref=e169]:
        - generic [ref=e171]:
          - generic [ref=e174]:
            - img [ref=e177]
            - generic [ref=e179]:
              - heading "📥 数据导出" [level=2] [ref=e180]
              - paragraph [ref=e181]: 导出你的学习数据
          - generic [ref=e182]:
            - generic [ref=e183]:
              - generic [ref=e184]:
                - generic [ref=e185]: 数据类型
                - group "数据类型" [ref=e187]:
                  - generic [ref=e188] [cursor=pointer]:
                    - generic [ref=e189]:
                      - checkbox "学习记录" [checked]
                    - generic [ref=e191]: 学习记录
                  - generic [ref=e192] [cursor=pointer]:
                    - generic [ref=e193]:
                      - checkbox "练习记录"
                    - generic [ref=e195]: 练习记录
                  - generic [ref=e196] [cursor=pointer]:
                    - generic [ref=e197]:
                      - checkbox "错题本"
                    - generic [ref=e199]: 错题本
                  - generic [ref=e200] [cursor=pointer]:
                    - generic [ref=e201]:
                      - checkbox "笔记"
                    - generic [ref=e203]: 笔记
              - generic [ref=e204]:
                - generic [ref=e205]: 导出格式
                - radiogroup "导出格式" [ref=e207]:
                  - generic [ref=e208] [cursor=pointer]:
                    - radio "Excel (.xlsx)" [checked] [ref=e210]
                    - generic [ref=e212]: Excel (.xlsx)
                  - generic [ref=e213] [cursor=pointer]:
                    - radio "CSV" [ref=e215]
                    - generic [ref=e217]: CSV
              - generic [ref=e218]:
                - generic [ref=e219]: 日期范围
                - generic [ref=e221]:
                  - img [ref=e223]
                  - combobox "日期范围" [ref=e225]
                  - generic [ref=e226]: 至
                  - combobox "结束日期" [ref=e227]
              - button "导出数据" [ref=e230] [cursor=pointer]:
                - generic [ref=e231]:
                  - img [ref=e233]
                  - text: 导出数据
            - separator [ref=e235]
            - generic [ref=e236]:
              - heading "说明" [level=4] [ref=e237]
              - list [ref=e238]:
                - listitem [ref=e239]: Excel 格式会将所有数据类型放在不同的工作表中
                - listitem [ref=e240]: CSV 格式每个数据类型单独下载一个文件
                - listitem [ref=e241]: 选择日期范围可以只导出指定时间段的数据
```