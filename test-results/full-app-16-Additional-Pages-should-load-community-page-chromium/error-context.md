...
- Name: full-app.spec.js >> 16. Additional Pages >> should load community page
- Location: tests\e2e\full-app.spec.js:552:3
          ...
          - generic [ref=e171]:
            - generic [ref=e173]:
              - generic [ref=e174]:
                - img [ref=e177]
                - generic [ref=e180]:
                  - heading "💬 学习社区" [level=2] [ref=e181]
                  - paragraph [ref=e182]: 与同学交流学习心得
              - button "发帖" [ref=e183] [cursor=pointer]:
                - generic [ref=e184]:
                  - img [ref=e186]
                  - text: 发帖
            - generic [ref=e189]:
              - tablist [ref=e193]:
                - tab "帖子讨论" [selected] [ref=e195]
                - tab "学习小组" [ref=e196]
              - tabpanel "帖子讨论" [ref=e198]:
                - generic [ref=e200]:
                  - img [ref=e202]
                  - paragraph [ref=e219]: 暂无帖子，快来发第一帖吧！
  - alert [ref=e220]:
    - img [ref=e222]
    - paragraph [ref=e224]: Request failed with status code 429
  - alert [ref=e225]:
    - img [ref=e227]
    - paragraph [ref=e229]: Request failed with status code 429
```